...
export default function Dashboard() {
  ...
  const token = localStorage.getItem('s4fitness_token')
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      try {
        ...
        if (!res.ok) { localStorage.removeItem('s4fitness_token'); localStorage.removeItem('s4fitness_user'); navigate('/login'); return }
  ...
  const handleLogout = () => {
    localStorage.removeItem('s4fitness_token')
    localStorage.removeItem('s4fitness_user')
    navigate('/')
  }
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="no-membership-card">
              ...
              <Link to="/membership" className="btn btn--primary btn--large no-membership-cta" id="dash-get-membership">
      ...
      <div className="container">
        ...
        <ScrollReveal delay={100}>
          <div className="dashboard-membership card">
            ...
            <Link to="/membership" className="btn btn--primary btn--small" id="dash-upgrade">Upgrade Plan</Link>
          </div>
        </ScrollReveal>
          ...
          <div className="dashboard-right">
            <ScrollReveal delay={300}>
              <div className="dashboard-section card">
                ...
                <Link to="/services" className="btn btn--secondary btn--small btn--full" style={{ marginTop: 'var(--space-md)' }} id="dash-services">
                  View All Programs
                </Link>
              </div>
            </ScrollReveal>
