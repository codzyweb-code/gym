...
const allTrainers = [
  { name: 'Sanal', role: 'Head Trainer', specialization: 'Strength & Conditioning, Powerlifting', experience: 8, instagram: '#' },
      ...
      <section className="section" id="why-choose-us">
        <div className="container">
          ...
          <div style={{ textAlign: 'center', marginTop: 'var(--space-3xl)' }}>
            <Link href="/membership" className="btn btn--primary btn--large" id="about-join-btn">
