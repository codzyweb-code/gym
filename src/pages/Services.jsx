        ...
        <div className="container" style={{ textAlign: 'center' }}>
          <ScrollReveal>
            ...
            <div style={{ display: 'flex', gap: 'var(--space-md)', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link to="/contact" className="btn btn--primary btn--large" id="services-consult-btn">
                Free Consultation <ArrowRight size={20} />
              </Link>
              <Link to="/membership" className="btn btn--secondary btn--large" id="services-pricing-btn">
                View Pricing
              </Link>
            </div>
          </ScrollReveal>
