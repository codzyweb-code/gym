        ...
        <div className="container hero__content">
          ...
          <ScrollReveal delay={300}>
            <div className="hero__actions">
              <Link to="/membership" className="btn btn--primary btn--large" id="hero-join-btn">
                Join Now <ArrowRight size={20} />
              </Link>
              <Link to="/contact" className="btn btn--secondary btn--large" id="hero-trial-btn">
      ...
      <section className="section section--dark" id="trainers-section">
        <div className="container">
          ...
          <div style={{ textAlign: 'center', marginTop: 'var(--space-3xl)' }}>
            <Link to="/about" className="btn btn--secondary" id="view-all-trainers-btn">
          ...
          <ScrollReveal>
            <div className="cta-box">
              ...
              <div className="cta-box__actions">
                <Link to="/membership" className="btn btn--primary btn--large" id="cta-join-btn">
                  Start Your Journey <ArrowRight size={20} />
                </Link>
                <Link to="/contact" className="btn btn--secondary btn--large" id="cta-contact-btn">
                  Contact Us
                </Link>
              </div>
            </div>
