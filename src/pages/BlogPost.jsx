  ...
  return (
    <div className="page-enter">
      <div className="blog-post-header" style={{ background: post.color }}>
        <div className="container">
          <Link to="/blog" className="blog-post-back"><ArrowLeft size={16} /> Back to Blog</Link>
      ...
      <section className="section">
        <div className="container container--narrow">
          ...
          <div className="blog-post-footer">
            <Link to="/blog" className="btn btn--secondary">← More Articles</Link>
            <Link to="/contact" className="btn btn--primary">Start Training Today</Link>
          </div>
        </div>
      </section>
